...
class _AdminDashboardState extends State<AdminDashboard> {
  ...
  Future<void> _addLecture(
    ...
    try {
      ...
      // If the file was picked from a path, copy it. Otherwise, write the bytes.
      if (file.path != null) {
      ...
      final prefs = await SharedPreferences.getInstance();
      // It's safer to read the latest list before writing
      ...
      // Reload the lectures from the source of truth
      await _loadLectures();
                  ...
                  onPressed: () async {
                    if (nameController.text.isNotEmpty &&
                      ...
                      if (mounted) {
                        ...
                        Navigator.of(context).pop(); // pop add lecture dialog
                      }
                    } else {
                      ScaffoldMessenger.of(context).showSnackBar(
